...
class FeaturesItemAdmin extends AbstractAdmin
{
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        if($this->hasParentFieldDescription()) {
            ...
            if($parent) {
                ...
                $subject = new \ZIMkaRU\CoreBundle\Entity\FeaturesItem;
            }
        } else {
    ...
    {
        $listMapper
            ->addIdentifier('featuresImage', 'string', array('template' => 'ZIMkaRUCoreBundle:IndexPageAdmin:list_field_image_thumb.html.twig'))
            ->addIdentifier('name')
